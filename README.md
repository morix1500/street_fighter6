...
* 近づくためにファランクス
* 基本的に2中パンチ→グラディウスを振っていく
* 大パンチは前進しながら攻撃するのでリーチが長い
* ラッシュ→od溜めグラディウスを入れると無敵技を返せる
* スクトゥムでインパクト返したら強パンチ→中タゲコンがいい

* 起き攻め（端投げ後）
  * ラッシュ投げ
  * ラッシュ→中
    * 気持ちディレイ気味にラッシュするとガード時に投げが出来る距離。ヒット時は4強Pがつながる
  * これらの起き攻めはラッシュ時にガードすれば無敵技対策になる